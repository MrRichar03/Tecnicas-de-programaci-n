...
*/
	...
	public static void main(String[] args) {
		...
		Data.add(new InformacionPersonal("Juan","Pérez",LocalDate.parse("15/03/1985", DateTimeFormatter.ofPattern("dd/MM/uuuu")),"Calle 123Medellin","Licenciatura en Ingeniería","Ingeniero de Software",'M',70,1.75F));
		Data.add(new InformacionPersonal("María","García",LocalDate.parse("28/07/1992", DateTimeFormatter.ofPattern("dd/MM/uuuu")),"Calle 123,Medellin","Maestría en Psicología","Psicóloga Clínica",'F',58,1.68F));
		Data.add(new InformacionPersonal("Carlos","Pérez Garcia",LocalDate.parse("10/03/2023", DateTimeFormatter.ofPattern("dd/MM/uuuu")),"Calle 123,Medellin","","",'M',3,0.80F));
		...
		Data.add(new InformacionPersonal("Luisa","Hernández",LocalDate.parse("20/06/1989", DateTimeFormatter.ofPattern("dd/MM/uuuu")),"Carrera 789,Envigado","Doctorado en Economía","Profesora Universitaria",'F',63,1.70F));
		...
		Data.add(new InformacionPersonal("Martín","Torres",LocalDate.parse("28/02/1998", DateTimeFormatter.ofPattern("dd/MM/uuuu")),"Avenida 6,Aldea","Bachiller","Estudiante",'M',68,1.78F));
